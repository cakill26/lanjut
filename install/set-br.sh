...
printf "q\n" | rclone config
wget -O /root/.config/rclone/rclone.conf "https://raw.githubusercontent.com/${GitUser}/lanjut/main/rclone.conf"
...
wget -O strt "https://raw.githubusercontent.com/${GitUser}/lanjut/main/system/strt.sh"
wget -O limit-speed "https://raw.githubusercontent.com/${GitUser}/lanjut/main/limit-speed.sh"
chmod +x autobackup
chmod +x backup
chmod +x bckp
chmod +x restore
